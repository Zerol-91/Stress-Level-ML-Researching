...
---
![Pasted image 20250927211248.png](https://github.com/Zerol-91/Stress-Level-ML-Researching/blob/main/images/Pasted%20image%2020250927211248.png?raw=true)
Это можно бы и оставить.
![Pasted image 20250927211357.png](https://github.com/Zerol-91/Stress-Level-ML-Researching/blob/main/images/Pasted%20image%2020250927211357.png?raw=true)
А вот это мб уберу. Но не для бейзлайна.

---
### Бейзлайн
![Pasted image 20250927220632.png](https://github.com/Zerol-91/Stress-Level-ML-Researching/blob/main/images/Pasted%20image%2020250927220632.png?raw=true)
Я так понял слишком много я просил выводить на обучении, так что у меня колаб вылетал.

![Результат бейзлайна](https://github.com/Zerol-91/Stress-Level-ML-Researching/blob/main/images/Pasted%20image%2020250927220715.png?raw=true)
Вот такой результат)

Я заменил все данные y_train на 5 и получил вот что после предсказания на настоящих тестовых данных:
![Pasted image 20250927222422.png](https://github.com/Zerol-91/Stress-Level-ML-Researching/blob/main/images/Pasted%20image%2020250927222213.png?raw=true)
Модель моя по итогу чуть чуть лучше чем случайность
...
plt.show()
```
Это код для графиков ниже

![Pasted image 20250927224511.png](https://github.com/Zerol-91/Stress-Level-ML-Researching/blob/main/images/Pasted%20image%2020250927224511.png?raw=true)

![Pasted image 20250927224633.png](https://github.com/Zerol-91/Stress-Level-ML-Researching/blob/main/images/Pasted%20image%2020250927224633.png?raw=true)

    
    - Возможно, существующие фичи действительно слабо связаны со стрессом. Тогда нужен **новый сбор данных** или более точные метрики (например, субъективные анкеты + объективные показатели).

---
![Pasted image 20250927225357.png](https://github.com/Zerol-91/Stress-Level-ML-Researching/blob/main/images/Pasted%20image%2020250927225357.png?raw=true)
Anxiety Level Стал оказался на удивление очень предсказуемым (При том, что по сетке гиперпараметров это не идеал)
